...
class CompanyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email": forms.EmailInput(attrs={"class": "form-control","placeholder": "empresa@dominio.com"}),
            "phone": forms.TextInput(attrs={"class": "form-control", "placeholder": "+54 9 341 1234567"}),
